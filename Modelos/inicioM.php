...
class InicioM extends ConexionBD {
    ...
    static public function ActualizarInicioM($tablaBD, $datosC) {
        // Obtener instancia de PDO
        $pdo = ConexionBD::getInstancia()->prepare("UPDATE $tablaBD SET intro = :intro, direccion = :direccion, horaE = :horaE, horaS = :horaS, telefono = :telefono, correo = :correo, logo = :logo, favicon = :favicon WHERE id = :id");
        ...
        return false; // Retornar false si no se ejecuta correctamente
    }
}

...
class InicioC
{
    public function MostrarInicioC()
    {
        ...
        // Asegúrate de que la clase InicioM esté correctamente cargada antes de llamar a sus métodos
        ...
        echo '<div class="box-body">
                <div class="col-md-6 bg-primary" style="margin-top: 5%">
                    ...
                    <hr>
                    <h2>Contactos:</h2>
                    <h3>Teléfono: ' . $resultado["telefono"] . ' <br> Correo: ' . $resultado["correo"] . '</h3>
                </div>
                <div class="col-md-6">
        ...
        echo '<form method="post" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-12">
                        ...
                        <br>
                        <img src="http://localhost/clinica/Vistas/img' . $resultado["logo"] . '" width="200px;">
                        ...
                        <br>
                        <img src="http://localhost/clinica/Vistas/img' . $resultado["favicon"] . '" width="200px;">
    ...
    public function ActualizarInicioC()
    {
        if (isset($_POST["Iid"])) {
            ...
            if ($resultado == true) {
                echo '<script> window.location = "inicio-editar"; </script>';
            }
        }
    }

...
require_once __DIR__ . "/../../Modelos/doctoresM.php"; // Asegúrate de que esta ruta sea correcta
require_once __DIR__ . "/../../Modelos/consultoriosM.php"; // Incluir el modelo de consultorios
?>
